...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const filteredFiveStarProduct = products.filter(
      (item) => item.avgRating === 5
    );
    ...
    <>
      ...
      <section className="md:flex lg:px-24  md:py-14 bg-blue-200 px-5 ">
        ...
        <div className="sm:p-10 sm:flex-col py-5">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
          >
            <button className="bg-black text-white px-5 py-2 rounded font-light">
              Shop Now
            </button>
          </motion.button>
        </div>
      ...
      <section className="  bg-indigo-900 md:px-[10%] mt-10 md:flex">
        <div className="p-10 text-white">
          ...
          >
            <button className="rounded-[5px] bg-opacity-100 text-white border-white border-[1px] text-sm p-2 hover:bg-white hover:text-indigo-900 ">
              View Product
            </button>
          </motion.button>
        </div>
